...
with beam.Pipeline(options=PipelineOptions()) as p:
        ...
        lines = p | 'ReadFile' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_2Bedroom.csv')
...
with beam.Pipeline(options=PipelineOptions()) as p:
        ...
        lines = p | 'ReadFile2' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_2Bedroom.csv')
...
with beam.Pipeline(options=PipelineOptions()) as p:
        ...
        lines = p | 'ReadFile3' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_2Bedroom.csv')

        list_records = lines | 'CreateListRecords3' >> (beam.Map(parse_line3))
...
def run(argv=None):
      ...
      '--job_name=zillow-rentals-2bedroom' # assign descriptive name to this job, all in lower case letters
        ...
        with beam.Pipeline(options=pipeline_options) as p:
                ...
                table_name = "wide-fx-193021:zillow.Rental_Price_2Bedroom" # format: project_id:dataset.table
                table_schema = init_bigquery_table()

                lines = p | 'ReadFile4' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_2Bedroom.csv')
