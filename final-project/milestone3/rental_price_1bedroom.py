...
with beam.Pipeline(options=PipelineOptions()) as p:
        ...
        lines = p | 'ReadFile' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_1Bedroom.csv')
...
with beam.Pipeline(options=PipelineOptions()) as p:
        ...
        lines = p | 'ReadFile2' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_1Bedroom.csv')
...
with beam.Pipeline(options=PipelineOptions()) as p:
        ...
        lines = p | 'ReadFile3' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_1Bedroom.csv')
...
def run(argv=None):
      ...
      '--job_name=zillow-rentals-1bedroom' # assign descriptive name to this job, all in lower case letters
        ...
        with beam.Pipeline(options=pipeline_options) as p:
                ...
                table_name = "wide-fx-193021:zillow.Rental_Price_1Bedroom" # format: project_id:dataset.table
                table_schema = init_bigquery_table()

                lines = p | 'ReadFile4' >> beam.io.ReadFromText('gs://rockstardotb/zillow/Zip_MedianRentalPrice_1Bedroom.csv')
